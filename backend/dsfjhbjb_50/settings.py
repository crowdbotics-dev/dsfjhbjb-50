"""
Django settings for dsfjhbjb_50 project.
...
WSGI_APPLICATION = 'dsfjhbjb_50.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dsfjhbjb_50 API",
    "DESCRIPTION": "API documentation for dsfjhbjb_50 App",
    "VERSION": "v1",
}
